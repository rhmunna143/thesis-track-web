    ...
    try {
      ...
      const updateData = {
        ...
        expertise: currentUser?.expertise 
          ...
          : null,
        profilePicture: uploadResult.url // Backend expects 'profilePicture'
      }
      ...
      if (updateResult?.success || updateResult?.id) {
        ...
        setProfileData(prev => ({ ...prev, profile_picture: uploadResult.url }))
          ...
          <Card className="text-center">
            ...
            {editing && (
              <div className="mt-4 p-4 bg-gray-50 rounded">
                <h4 className="text-sm font-medium mb-2">Update Profile Photo</h4>
                <Upload {...uploadProps}>
                  <Button 
                    icon={<UploadOutlined />} 
